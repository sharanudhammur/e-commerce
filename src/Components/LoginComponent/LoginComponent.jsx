        ...
        <div className='login_component'>
            <div className="bg-white shadow-md" style={{ border: "1px solid lightgray" }}>
                <div className="py-8 px-8 rounded-xl" >
                    <h1 className="font-medium text-2xl mt-2 text-center">Login</h1>
                    ...
                    <div className="flex md:justify-between justify-center items-center mt-5">
                        ...
                        <p className="md:mx-2 text-sm text-gray-600"> Login With Social </p>
                        <div className="bg-gray-300 md:block hidden w-4/12"></div>
                    </div>
                    ...
                    <p className="mt-7 text-sm text-center text-gray-600"> Don't have an account? <span onClick={() => navigateTo()} className="text-black font-medium"> Create One </span>  </p>
